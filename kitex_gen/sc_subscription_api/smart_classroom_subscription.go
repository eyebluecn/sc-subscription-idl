...
func (p *SubscriptionServiceClient) SubscriptionRichPage(ctx context.Context, request *SubscriptionRichPageRequest) (r *SubscriptionRichPageResponse, err error) {
	var _args SubscriptionServiceSubscriptionRichPageArgs
	_args.Request = request
	var _result SubscriptionServiceSubscriptionRichPageResult
...
func NewSubscriptionServiceProcessor(handler SubscriptionService) *SubscriptionServiceProcessor {
	...
	self.AddToProcessorMap("SubscriptionRichPage", &subscriptionServiceProcessorSubscriptionRichPage{handler: handler})
...
type subscriptionServiceProcessorSubscriptionRichPage struct {
	handler SubscriptionService
}

func (p *subscriptionServiceProcessorSubscriptionRichPage) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := SubscriptionServiceSubscriptionRichPageArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := SubscriptionServiceSubscriptionRichPageResult{}
...
func NewSubscriptionServiceSubscriptionRichPageArgs() *SubscriptionServiceSubscriptionRichPageArgs {
	return &SubscriptionServiceSubscriptionRichPageArgs{}
}

func (p *SubscriptionServiceSubscriptionRichPageArgs) InitDefault() {
	*p = SubscriptionServiceSubscriptionRichPageArgs{}
}

var SubscriptionServiceSubscriptionRichPageArgs_Request_DEFAULT *SubscriptionRichPageRequest

func (p *SubscriptionServiceSubscriptionRichPageArgs) GetRequest() (v *SubscriptionRichPageRequest) {
	if !p.IsSetRequest() {
		return SubscriptionServiceSubscriptionRichPageArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *SubscriptionServiceSubscriptionRichPageArgs) SetRequest(val *SubscriptionRichPageRequest) {
	p.Request = val
}

var fieldIDToName_SubscriptionServiceSubscriptionRichPageArgs = map[int16]string{
	1: "request",
}

func (p *SubscriptionServiceSubscriptionRichPageArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *SubscriptionServiceSubscriptionRichPageArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SubscriptionServiceSubscriptionRichPageArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SubscriptionServiceSubscriptionRichPageArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *SubscriptionServiceSubscriptionRichPageArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *SubscriptionServiceSubscriptionRichPageArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *SubscriptionServiceSubscriptionRichPageArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SubscriptionServiceSubscriptionRichPageArgs(%+v)", *p)

}

func (p *SubscriptionServiceSubscriptionRichPageArgs) DeepEqual(ano *SubscriptionServiceSubscriptionRichPageArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SubscriptionServiceSubscriptionRichPageArgs) Field1DeepEqual(src *SubscriptionRichPageRequest) bool {
...
func NewSubscriptionServiceSubscriptionRichPageResult() *SubscriptionServiceSubscriptionRichPageResult {
	return &SubscriptionServiceSubscriptionRichPageResult{}
}

func (p *SubscriptionServiceSubscriptionRichPageResult) InitDefault() {
	*p = SubscriptionServiceSubscriptionRichPageResult{}
}

var SubscriptionServiceSubscriptionRichPageResult_Success_DEFAULT *SubscriptionRichPageResponse

func (p *SubscriptionServiceSubscriptionRichPageResult) GetSuccess() (v *SubscriptionRichPageResponse) {
	if !p.IsSetSuccess() {
		return SubscriptionServiceSubscriptionRichPageResult_Success_DEFAULT
	}
	return p.Success
}
func (p *SubscriptionServiceSubscriptionRichPageResult) SetSuccess(x interface{}) {
	p.Success = x.(*SubscriptionRichPageResponse)
}

var fieldIDToName_SubscriptionServiceSubscriptionRichPageResult = map[int16]string{
	0: "success",
}

func (p *SubscriptionServiceSubscriptionRichPageResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SubscriptionServiceSubscriptionRichPageResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SubscriptionServiceSubscriptionRichPageResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SubscriptionServiceSubscriptionRichPageResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *SubscriptionServiceSubscriptionRichPageResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *SubscriptionServiceSubscriptionRichPageResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *SubscriptionServiceSubscriptionRichPageResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SubscriptionServiceSubscriptionRichPageResult(%+v)", *p)

}

func (p *SubscriptionServiceSubscriptionRichPageResult) DeepEqual(ano *SubscriptionServiceSubscriptionRichPageResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SubscriptionServiceSubscriptionRichPageResult) Field0DeepEqual(src *SubscriptionRichPageResponse) bool {
